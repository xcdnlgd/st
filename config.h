 ...
 */
static char *font = "JetBrainsMonoNL Nerd Font:regular:pixelsize=24:antialias=true:autohint=true";
// static char *font = "JetBrainsMonoNL Nerd Font:pixelsize=16:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
    "Adwaita Mono:regular:pixelsize=24:antialias=true:autohint=true"
